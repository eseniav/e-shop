    ...
    internal class Program {
        static void Main()
        {
            ...
            List<Product> products = new List<Product>()
                {
            new Book("Властелин Колец: Братство Кольца", 899m, store.manufacturers[1], "Дж. Р. Р. Толкин")
                {
                    BookGenre = Book.Genre.Фэнтези,
                    PublicationDate = 1954
                },
            new Book("1984", 450m, store.manufacturers[2], "Джордж Оруэлл")
                {
                    BookGenre = Book.Genre.Антиутопия,
                    PublicationDate = 1949
                },
            new Book("Убийство в \"Восточном экспрессе\"", 680m, store.manufacturers[2], "Агата Кристи")
                {
                    BookGenre = Book.Genre.Детектив,
                    PublicationDate = 1934
                },
            new Book("Марсианин", 750m, store.manufacturers[3], "Энди Вейер")
                {
                    BookGenre = Book.Genre.НаучнаяФантастика,
                    PublicationDate = 2011
                },
            new Book("Гарри Поттер и философский камень", 1200m, store.manufacturers[1], "Дж. К. Роулинг")
                {
                    BookGenre = Book.Genre.Фэнтези,
